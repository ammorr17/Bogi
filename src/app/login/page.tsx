...
export default function LoginPage() {
  ...
  async function handleGoogleSignIn() {
    ...
    // only runs when something went wrong before that redirect happened.
    if (error) {
      ...
      {status === "sent" ? (
        ...
        <>
          <button
            ...
            className="flex items-center justify-center gap-2 rounded-lg border border-gray-300 px-4 py-2 text-sm font-medium disabled:opacity-50"
          >
            <GoogleIcon />
...
function GoogleIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 48 48" aria-hidden="true">
      ...
      <path
        fill="#1976D2"
        d="M43.6 20.5H42V20H24v8h11.3c-.8 2.3-2.2 4.2-4 5.6l6.6 5.6C41.5 35.9 44 30.4 44 24c0-1.3-.1-2.7-.4-3.5z"
      />
    </svg>
  );
}
